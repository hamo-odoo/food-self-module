...
class FoodOrder(models.Model):
    ...
    delivery_partner_id=fields.Many2one("food.delivery.partner",compute="_onchange_state",readonly=False,store=True)
    ...
    def _onchange_state(self):
        for record in self:
            ...
            if record.state=='delivered':
                record.delivery_partner_id.current_order_assigned=False
